...
# CUSTOM LINKS
CUSTOM_LINK_ONE_NAME="FALE CONOSCO"
CUSTOM_LINK_ONE_DESCRIPTION="Nós gostaríamos de ouvir de você"
CUSTOM_LINK_ONE_ADDRESS="http://jcnassur.com.br"
...
# YAML Files
DOCKER_COMPOSE_YML_FILE="https://raw.githubusercontent.com/cimitrasoftware/integrate-jcnassur/master/docker-compose.yml"
DOCKER_COMPOSE_YML_444_FILE="https://raw.githubusercontent.com/cimitrasoftware/integrate-jcnassur/master/docker-compose-444.yml"

# BRANDING IMAGE FILES
PNG_FILE_IN="https://raw.githubusercontent.com/cimitrasoftware/integrate-jcnassur/master/jcnassur.png"

SVG_FILE_IN="https://raw.githubusercontent.com/cimitrasoftware/integrate-jcnassur/master/jcnassur.svg"

SVG_FILE_OUT="jcnassur.svg"

PNG_FILE_OUT="jcnassur.png"
...
{
echo ""
echo "Obrigado por instalar tudo JCNASSUR/Cimitra"
echo ""
}